...
public class URLUtils {
  ...
  public static URL getAlternateCaseURL(final URL url) {
    try {
      ...
      final String altFilename = StrUtils.getAlternateCaseString(filename);
  ...
  public static URLContentsContainer getContent(final URL url, final long maxLength)
      throws IOException {
    long curLength = 0;
    int chunkSize = 1024;
    ...
    if (contentType == null || TEXT_CONTENT_TYPES.contains(contentType)) {
      ...
      int amtRead = 0;
      while ((maxLength == -1 || curLength < maxLength) && -1 != (amtRead = is.read(buf))) {
        curLength += amtRead;
  ...
  public static URLContentsContainer getContent(final URL url) throws IOException {
  ...
  public static String getContentType(final URLConnection connection, final URL url,
  ...
  public static String getCharset(final URLConnection connection, final String defaultCharset) {
  ...
  public static URL newURL(final URL base, final String filename) throws MalformedURLException {
